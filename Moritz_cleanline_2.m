...
for q = 1:length(list)
    ...
    subject.trial = [];
    for ii = 1:size(clean_signal.data,3)
    subject.trial{ii} = squeeze(clean_signal.data(:,:,ii));
    end
    ...
    disp 'saving...'
    save([subID '_' group_identifier '_cleanLine_rmline_2.mat'],'subject');
    ...
    clear subject filename new_data signal
