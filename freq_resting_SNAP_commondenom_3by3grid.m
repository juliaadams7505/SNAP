...
data_path = 'M:\\SNAP_Data_Processed\\foof_files_default';
cd(data_path);
...
load('M:\SNAP_Data_Processed\processed\137_HC.mat');
   ...
   for ch = 1:size(master_fooof_results,1);
      ...
      meantempA = squeeze(mean(tempA,3));
...
cfg = [];
cfg.keepindividual = 'yes';
group_data_HC = ft_freqgrandaverage(cfg, group_data_HC{1:end});
group_data_CC = ft_freqgrandaverage(cfg, group_data_CC{1:end});
group_data_UHR = ft_freqgrandaverage(cfg, group_data_UHR{1:end});
...
foi_norm  = nearest(group_data_HC{1,1}.freq, freq_norm);
...
group_data_HC_FL_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_FL_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_FL_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_FM_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_FM_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_FM_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_FR_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_FR_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_FR_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_PL_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_PL_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_PL_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_PM_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_PM_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_PM_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_PR_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_PR_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_PR_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_OL_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_OL_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_OL_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_OM_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_OM_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_OM_ROI = ft_selectdata(cfg, group_data_UHR);
...
cfg.avgoverfreq = 'yes';
cfg.parameter   = {'powspctrm','powspctrm_b'};
group_data_HC_OR_ROI = ft_selectdata(cfg, group_data_HC);
group_data_CC_OR_ROI = ft_selectdata(cfg, group_data_CC);
group_data_UHR_OR_ROI = ft_selectdata(cfg, group_data_UHR);
...
data_raw_FR_ROI    = {group_data_HC_FR_ROI.powspctrm...
  group_data_CC_FR_ROI.powspctrm...
  group_data_UHR_FR_ROI.powspctrm};
  
data_between_FR_ROI ={group_data_HC_FR_ROI.powspctrm_b...
  group_data_CC_FR_ROI.powspctrm_b...
  group_data_UHR_FR_ROI.powspctrm_b};

data_raw_PL_ROI = {group_data_HC_PL_ROI.powspctrm...
  group_data_CC_PL_ROI.powspctrm...
  group_data_UHR_PL_ROI.powspctrm};
  
data_between_PL_ROI ={group_data_HC_PL_ROI.powspctrm_b...
  group_data_CC_PL_ROI.powspctrm_b...
  group_data_UHR_PL_ROI.powspctrm_b};

data_raw_PM_ROI    = {group_data_HC_PM_ROI.powspctrm...
  group_data_CC_PM_ROI.powspctrm...
  group_data_UHR_PM_ROI.powspctrm};
  
data_between_PM_ROI ={group_data_HC_PM_ROI.powspctrm_b...
  group_data_CC_PM_ROI.powspctrm_b...
  group_data_UHR_PM_ROI.powspctrm_b};

data_raw_PR_ROI    = {group_data_HC_PR_ROI.powspctrm...
  group_data_CC_PR_ROI.powspctrm...
  group_data_UHR_PR_ROI.powspctrm};
  
data_between_PR_ROI ={group_data_HC_PR_ROI.powspctrm_b...
  group_data_CC_PR_ROI.powspctrm_b...
  group_data_UHR_PR_ROI.powspctrm_b};

data_raw_OL_ROI = {group_data_HC_OL_ROI.powspctrm...
  group_data_CC_OL_ROI.powspctrm...
  group_data_UHR_OL_ROI.powspctrm};
  
data_between_OL_ROI ={group_data_HC_OL_ROI.powspctrm_b...
  group_data_CC_OL_ROI.powspctrm_b...
  group_data_UHR_OL_ROI.powspctrm_b};

data_raw_OM_ROI    = {group_data_HC_OM_ROI.powspctrm...
  group_data_CC_OM_ROI.powspctrm...
  group_data_UHR_OM_ROI.powspctrm};
...
ylabel('abs. power (V^2)');
title('raw Front Middle');

subplot(2,3,4);
h6 = plotSpread(data_between_FM_ROI,[],[],{'Healthy Control','Clinical Control','Ultra-High Risk'});
ylabel('rel. power');
title('between Front Middle');
set(h6{1},'LineWidth',1,'Marker', '.','Color','k','MarkerFaceColor','k')

subplot(2,3,5);
h6 = plotSpread(data_raw_FR_ROI,[],[],{'Healthy Control','Clinical Control','Ultra-High Risk'});
ylabel('abs. power (V^2)');
title('between Front Right');
set(h6{1},'LineWidth',1,'Marker', '.','Color','k','MarkerFaceColor','k')
...
cfg.highlightchannel = {FL_ROI FM_ROI FR_ROI PL_ROI PM_ROI PR_ROI OL_ROI OM_ROI OR_ROI};
...
subplot(2,4,5);loglog(group_data_HC.freq,...
  [squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_FL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_FM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_FR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_PL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_PM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_PR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_OL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_OM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_HC.(cfg.parameter)(:,sel_OR_ROI,:),2),1))]);
xlim([0.5 45]);
grid on; hold on;
plot([10,10],[10^-3 10^2],'--k')
ylim([10^-3 10^2]);
legend('FL ROI', 'FM ROI', 'FR_ROI', 'PL_ROI', 'PM_ROI', 'PR_ROI', 'OL_ROI', 'OM_ROI', 'OR_ROI', 'Location', 'southwest');
...
subplot(2,4,6);loglog(group_data_CC.freq,...
   [squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_FL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_FM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_FR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_PL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_PM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_PR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_OL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_OM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_CC.(cfg.parameter)(:,sel_OR_ROI,:),2),1))]);
xlim([0.5 45]);
grid on; hold on;
plot([10,10],[10^-3 10^2],'--k')
ylim([10^-3 10^2]);
...
subplot(2,4,7);loglog(group_data_UHR.freq,...
   [squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_FL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_FM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_FR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_PL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_PM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_PR_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_OL_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_OM_ROI,:),2),1))...
  squeeze(mean(mean(group_data_UHR.(cfg.parameter)(:,sel_OR_ROI,:),2),1))]);
xlim([0.5 45]);
grid on; hold on;
plot([10,10],[10^-3 10^2],'--k')
ylim([10^-3 10^2]);
...
electrodeName = 'P4','P6','P8','PO6','PO8','02','CB2'; %this electrode
