...
common_denominator = mean(group_data_HC.powspctrm(:,:,foi_norm(1):foi_norm(2)),3);
group_data_HC.powspctrm_b = bsxfun(@rdivide, group_data_HC.powspctrm, common_denominator);     
group_data_CC.powspctrm_b = bsxfun(@rdivide, group_data_CC.powspctrm, common_denominator);
group_data_UHR.powspctrm_b = bsxfun(@rdivide, group_data_UHR.powspctrm, common_denominator);
